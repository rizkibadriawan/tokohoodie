                ...
                <div class="col-sm-6">
                    <div class="contactinfo">
                        <ul class="nav nav-pills">
                            <li><a href="#"><i class="fa fa-phone"></i> 022-10516058</a></li>
                            <li><a href="#"><i class="fa fa-envelope"></i> tokohoodie@gmail.com</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-sm-6">
                ...
                <div class="col-sm-9">
                    ...
                    <div class="mainmenu pull-left">
                        <ul class="nav navbar-nav collapse navbar-collapse">
                            ...
                            <li><a href="https://www.facebook.com/rizki.badriawan.543" target="_blank">Contact admin</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-sm-3">
