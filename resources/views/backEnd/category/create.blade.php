...
@section('content')
    <div id="breadcrumb"> <a href="{{url('/admin')}}" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="{{route('category.index')}}">Kategori</a> <a href="{{route('category.create')}}" class="current">Tambahkan Kategori Baru</a> </div>
                ...
                <div class="widget-content nopadding">
                    <form class="form-horizontal" method="post" action="{{route('category.store')}}" name="basic_validate" id="basic_validate" novalidate="novalidate">
                        ...
                        <div class="control-group{{$errors->has('url')?' has-error':''}}">
                            <label class="control-label">URL (Awali Dengan http://) :</label>
                            <div class="controls">
                        ...
                        <div class="control-group{{$errors->has('status')?' has-error':''}}">
                            <label class="control-label">Aktifkan Produk Ini :</label>
                            <div class="controls">
