...
@section('content')
    <div id="breadcrumb"> <a href="{{url('/admin')}}" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="{{route('product.index')}}">Produk</a> <a href="#" class="current">Tambah Gambar</a> </div>
    <div class="container-fluid">
        @if(Session::has('message'))
            <div class="alert alert-success text-center" role="alert">
                <strong>Selesai!! &nbsp;</strong>{{Session::get('')}}
            </div>
        @endif
        <div class="row-fluid">
            <div class="span6">
                        ...
                        <ul class="recent-posts">
                            ...
                            <li>
                                <form action="{{route('image-gallery.store')}}" method="post" role="form" enctype="multipart/form-data">
                                    <legend>Tambah Lebih Banyak Gambar</legend>
                            ...
                            <?php $i=1; ?>
                                @foreach($imageGalleries as $imageGallery)
                                    <tr>
                                        ...
                                        <td style="text-align: center;vertical-align: middle;"><a href="javascript:" rel="{{$imageGallery->id}}" rel1="delete-imageGallery" class="btn btn-danger btn-mini deleteRecord">Hapus</a></td>
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
