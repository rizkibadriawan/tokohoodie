...
@section('content')
    <div id="breadcrumb"> <a href="{{url('/admin')}}" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="{{route('product.index')}}">Produk</a> <a href="{{route('product.create')}}" class="current">Tambah Produk Baru</a> </div>
    <div class="container-fluid">
        @if(Session::has('message'))
            <div class="alert alert-success text-center" role="alert">
                <strong>Berhasil.!! &nbsp;</strong>{{Session::get('')}}
            </div>
        @endif
        <div class="widget-box">
            ...
            <div class="widget-content nopadding">
                <form action="{{route('product.store')}}" method="post" class="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="control-group">
                        <label for="p_code" class="control-label">Kode</label>
                    ...
                    <div class="control-group">
                        <label for="p_color" class="control-label">Warna</label>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls{{$errors->has('description')?' has-error':''}}">
                            <textarea class="textarea_editor span12" name="description" id="description" rows="6" placeholder="Diskripsi Produk" style="width: 580px;">{{old('description')}}</textarea>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls{{$errors->has('price')?' has-error':''}}">
                            <div class="input-prepend"> <span class="add-on">IDR</span>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <button type="submit" class="btn btn-success">Tambah Produk Baru</button>
                        </div>
                    </div>
                </form>
            </div>
